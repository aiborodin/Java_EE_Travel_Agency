...
public class TravelOfferDAOImpl implements TravelOfferDao {
    ...
    @Override
    public List<TravelOffer> readAll() {
                    ...
                    while (travelOffersData.next()) {
                        travelOffers.add(
                                new TravelOffer(
                                        ...
                                        travelOffersData.getString("offer_type")
                                )
                        );
                    }
                }
    ...
    @Override
    public int add(TravelOffer travelOffer) {
        try (Connection connection = dataSource.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement(addQuery)) {
                ...
                statement.setString(3, travelOffer.getOfferType());
                statement.executeUpdate();
            }
